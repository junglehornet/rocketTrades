...
If you think you've found a bug with the mod, please first make sure that it is an issue with the RocketTrades mod and not the Architectury API mod. If it is an issue with RocketTrades, then please [open an issue on GitHub](https://github.com/junglehornet/rocketTrades/issues/new).
</details>
